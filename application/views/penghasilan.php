    ...
    <div class="col-md-12">
        <div id="content">
            ...
            <table class="table table-striped" align="center">
                <tr id="thead">
                    <td>Id penghasilan</td>
                    <td>No rekening</td>
                    <td>Penghasilan suami</td>
                    <td>Penghasilan istri</td>
                    <td>Penghasilan lainnya</td>
                    <td>Biaya rumah tangga</td>
                    <td>Biaya kebutuhan anak</td>
                    <td>Pengeluaran pribadi</td>
                    <td>Pengeluaran lainnya</td>
                    <td>Status data penghasilan</td>
                    <td></td>
                </tr>
                <?php $id_penghasilan = 1; foreach($bmt->datapenghasilan as $value) { ?>
                <tr>
                    <td><?php echo $id_penghasilan++; ?></td>
                    ...
                    <td><?php echo $value->biaya_kebutuhan_anak; ?></td>
                    <td><?php echo $value->pengeluaran_pribadi; ?></td>
                    <td><?php echo $value->pengeluaran_lainnya; ?></td>
                    <td><?php echo $value->status_datapenghasilan; ?></td>
                </tr>
                <?php } ?>
            </table>
            </center>
